...
SEED_PRODUCTS = [
    ...
    },
    {
        ...
        "description": 'Apple M3 chip, 18-hour battery, 13.6" Liquid Retina display',
        "sku": "APL-MBA-M3-8",
    },
    {
        ...
        "description": 'Intel Core i9, 32GB RAM, 1TB SSD, 15.6" OLED 4K display',
        "sku": "DEL-XPS15-I9",
    },
    {
    ...
    },
    {
        ...
        "description": "Quantum HDR, 120Hz, Tizen OS, Dolby Atmos sound",
        "sku": "SAM-TV65-QLED",
    },
    {
        ...
        "description": "M2 chip, Liquid Retina XDR, Wi-Fi 6E, Apple Pencil support",
        "sku": "APL-IPADP-M2",
    },
    {
        ...
        "description": "24.2MP APS-C sensor, 4K video, dual pixel autofocus, Wi-Fi",
        "sku": "CAN-EOSR50-KIT",
    },
    {
        ...
        "description": "Max Air unit in heel, lightweight mesh upper, comfortable all-day wear",
        "sku": "NKE-AM270-BLK",
    },
    {
        ...
        "description": "Slim fit, sits below waist, straight through thigh, tapered leg",
        "sku": "LVI-511-SLM-32",
    },
    {
    ...
    },
    {
        ...
        "description": "Iconic aviator frame, G-15 green lenses, UV protection",
        "sku": "RB-3025-G15",
    },
    {
        ...
        "description": "Laser dust detection, LCD screen, 60min runtime",
        "sku": "DYS-V15-DET",
    },
    {
    ...
    },
    {
        ...
        "description": "7.2L capacity, 80% less fat, digital touchscreen, 7 preset programs",
        "sku": "PHL-AF-XXL",
    },
    {
    ...
    },
    {
        ...
        "description": "Carbon graphite shaft, 85g, repulsion power technology",
        "sku": "YNX-ARC11-G4",
    },
    {
        ...
        "description": "2% Hyaluronic acid, multi-depth hydration, plumped skin",
        "sku": "TOD-HA-30ML",
    },
    {
        ...
        "description": "42H playback, Beast Mode gaming, IPX4 water resistance",
        "sku": "BOAT-AD141",
    },
]
...
SEED_REVIEWS = [
    (
        ...
        "Rahul S.",
        5,
        "Best phone I've used. Camera quality is phenomenal!",
        "2024-01-15",
    ),
    ...
    (
        ...
        "Amit K.",
        4,
        "Great phone but very expensive. Battery could be better.",
        "2024-02-01",
    ),
    (
        3,
        "Sneha R.",
        5,
        "Lightning fast, amazing battery. Best laptop for creators.",
        "2024-01-10",
    ),
    ...
    (
        ...
        "Anjali D.",
        5,
        "Noise cancellation is absolutely insane. Love it!",
        "2024-01-25",
    ),
...
def get_products():
    ...
    if q:
        sql += " AND (LOWER(name) LIKE LOWER(?) OR LOWER(brand) LIKE LOWER(?) OR LOWER(description) LIKE LOWER(?))"
        params += [f"%{q}%", f"%{q}%", f"%{q}%"]
    ...
    for p in products:
        p["discount"] = (
            int((1 - p["price"] / p["original_price"]) * 100)
...
def get_product(pid):
    ...
    reviews = [
        ...
        for r in conn.execute(
            "SELECT * FROM reviews WHERE product_id=? ORDER BY date DESC", (pid,)
        ).fetchall()
    ]
    conn.close()
    p["discount"] = (
...
def add_review(pid):
    ...
    conn.execute(
        ...
        (stats["cnt"], round(stats["avg"], 1), pid),
    )
    conn.commit()
    conn.close()
...
def create_product():
    ...
    conn = get_db()
    cur = conn.execute(
        "INSERT INTO products (name,category,brand,price,original_price,stock,description,image,sku) VALUES (?,?,?,?,?,?,?,?,?)",
        (
            data["name"],
            data.get("category", ""),
            data.get("brand", ""),
...
def get_stats():
    ...
    low_stock = conn.execute(
        "SELECT COUNT(*) FROM products WHERE stock < 20"
    ).fetchone()[0]
    by_cat = conn.execute(
