...
def test_register(client):
    r = client.post(
        "/users/register",
        json={"name": "Vivek Singh", "email": "vivek@test.com", "password": "pass123"},
    )
...
def test_register_duplicate_email(client):
    client.post(
        "/users/register",
        json={"name": "User1", "email": "dup@test.com", "password": "pass"},
    )
    r = client.post(
        "/users/register",
        json={"name": "User2", "email": "dup@test.com", "password": "pass"},
    )
...
def test_login(client):
    client.post(
        "/users/register",
        json={"name": "Login User", "email": "login@test.com", "password": "secret"},
    )
    r = client.post(
        "/users/login", json={"email": "login@test.com", "password": "secret"}
    )
    assert r.status_code == 200
...
def test_login_wrong_password(client):
    client.post(
        "/users/register",
        json={"name": "User", "email": "wp@test.com", "password": "correct"},
    )
...
def test_get_user(client):
    r = client.post(
        "/users/register",
        json={"name": "GetUser", "email": "get@test.com", "password": "pass"},
    )
...
def test_update_user(client):
    r = client.post(
        "/users/register",
        json={"name": "OldName", "email": "update@test.com", "password": "pass"},
    )
    uid = r.get_json()["user_id"]
...
def test_delete_user(client):
    r = client.post(
        "/users/register",
        json={"name": "ToDelete", "email": "del@test.com", "password": "pass"},
    )
    uid = r.get_json()["user_id"]
